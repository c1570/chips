    ...
    if (must_tick_c64) {
      ...
      if (prog == 0xFF || prog == 0xEE || timeout) {
        static const uint8_t expected[256] = {
            
        };
        int pass = (prog == 0xFF);
        if (pass) {
          for (int i = 0; i < 256; i++) {
        ...
        if (!pass) {
          printf("  Buffer $C000:");
          for (int i = 0; i < 256; i++) printf(" %02X", c64_ram_read(0xC000 + i));
          printf("\n  Expected:    ");
          for (int i = 0; i < 256; i++) printf(" %02X", expected[i]);
          printf("\n");
        }
        free(hz_needed);
        return pass ? 0 : 1;
