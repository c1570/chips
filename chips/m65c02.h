...
#define M65C02_PIN_SYNC  (25)      // out: start of a new instruction
#define M65C02_PIN_IRQ   (26)      // in: maskable interrupt requested
#define M65C02_PIN_NMI   (27)      // in: non-maskable interrupt requested
#define M65C02_PIN_RDY   (28)      // in: freeze execution at next read cycle
#define __hidden_M6510_PIN_AEC   (29)      // in, __hidden_m6510 only, put bus lines into tristate mode, not implemented
#define M65C02_PIN_RES   (30)      // request RESET
